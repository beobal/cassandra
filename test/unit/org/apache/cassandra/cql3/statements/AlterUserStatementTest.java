...
public class AlterUserStatementTest
{
    ...
    {
        Assert.assertNull(dcPerms("ALTER USER r1 WITH PASSWORD 'password'"));
    }

    @Test
    public void dcsAllSpecified() throws Exception
    {
        DCPermissions dcPerms = dcPerms("ALTER USER r1 WITH ALL DATACENTERS");
    ...
    {
        DCPermissions dcPerms = dcPerms("ALTER USER r1 WITH DATACENTERS 'dc1'");
        Assert.assertNotNull(dcPerms);
    ...
    {
        DCPermissions dcPerms = dcPerms("ALTER USER r1 WITH DATACENTERS 'dc1' OR 'dc2'");
        Assert.assertNotNull(dcPerms);
        Assert.assertTrue(dcPerms.restrictsAccess());
