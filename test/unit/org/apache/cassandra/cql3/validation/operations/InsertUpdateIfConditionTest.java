...
public class InsertUpdateIfConditionTest extends CQLTester
{
    ...
    public static void beforeSetup(NodeVersion clusterMinVersion)
    {
        ...
        assertEquals(directory.clusterMaxVersion, NodeVersion.CURRENT);
        ...
        assertEquals(ClusterMetadata.current().directory.commonSerializationVersion, NodeVersion.CURRENT_METADATA_VERSION);
    }
