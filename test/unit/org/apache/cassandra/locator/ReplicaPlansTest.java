...
public class ReplicaPlansTest
{
    ...
    static
    {
        ...
        Map<String, String> replication = ImmutableMap.of("class", "NetworkTopologyStrategy", "DC1", "3", "DC2", "3");
        ks = Keyspace.mockKS(KeyspaceMetadata.create("blah", KeyspaceParams.create(false, replication)));
    }
    ...
    public void testWriteEachQuorum()
    {
        ...
        }
        {
            ...
            // TODO looks like this misconfigured the RF in the original version (i.e. no transient replicas)
