...
public class NetworkPermissionsCacheKeysTableTest extends CQLTester
{
    ...
    {
        UntypedResultSet result = execute("SELECT * FROM vts.network_permissions_cache_keys");
    ...
    {
        UntypedResultSet result = execute("SELECT * FROM vts.network_permissions_cache_keys WHERE role='role_a'");
