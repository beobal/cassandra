...
public class PermissionsCacheKeysTableTest extends CQLTester
{
    ...
    {
        UntypedResultSet result = execute("SELECT * FROM vts.permissions_cache_keys");
    ...
    {
        UntypedResultSet result = execute("SELECT * FROM vts.permissions_cache_keys WHERE role='role_a' AND resource='data'");
    ...
    public void testSelectPartitionWhenPermissionsAreCached() throws Throwable
    {
        ...
        assertRows(result, row("role_a", "data"));
    }
    ...
    public void testDeletePartition() throws Throwable
    {
        ...
        assertRows(result, row("role_a", "data/cql_test_keyspace"));
    }
