...
public class JmxPermissionsCacheKeysTableTest extends CQLTester
{
    ...
    {
        UntypedResultSet result = execute("SELECT * FROM vts.jmx_permissions_cache_keys");
    ...
    {
        UntypedResultSet result = execute("SELECT * FROM vts.jmx_permissions_cache_keys WHERE role='role_a'");
