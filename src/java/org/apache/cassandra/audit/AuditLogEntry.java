...
public class AuditLogEntry
{
    ...
    private AuditLogEntry(Builder builder)
    {
        ...
        this.nodeId = StorageService.instance.getNodeId();
    }
    ...
    String getLogString(String keyValueSeparator, String fieldSeparator)
    {
        ...
        builder.append("user").append(keyValueSeparator).append(user)
               .append(fieldSeparator).append("host_id").append(keyValueSeparator).append(nodeId.toUUID().toString())
               .append(fieldSeparator).append("node_id").append(keyValueSeparator).append(nodeId.id())
