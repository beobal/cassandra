...
public class PrepareDropAccordTable implements Transformation
{
    ...
    {
        KeyspaceMetadata ks = prev.schema.getKeyspaces().getNullable(tableRef.keyspace);
        if (ks == null)
            return new Rejected(ExceptionCode.INVALID, "Unknown keyspace " + tableRef.keyspace);
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof PrepareDropAccordTable)) return false;
