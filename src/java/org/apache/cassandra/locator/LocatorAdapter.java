 ...
 */
// TODO rename
public class LocatorAdapter implements Locator, RegistrationStateCallbacks
{
    private static final Logger logger = LoggerFactory.getLogger(LocatorAdapter.class);
    ...
    public LocatorAdapter(InetAddressAndPort localEndpoint, InitialLocationProvider provider)
    {
    ...
    public static LocatorAdapter forClients()
    {
        return new LocatorAdapter(FBUtilities.getBroadcastAddressAndPort(), () -> Location.UNKNOWN);
    }
