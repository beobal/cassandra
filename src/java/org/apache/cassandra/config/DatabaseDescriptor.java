...
public class DatabaseDescriptor
{
    ...
    public static void applyConfig(Config config) throws ConfigurationException
    {
        ...
        if (conf.native_transport_max_negotiable_version != Integer.MIN_VALUE)
        {
            if (conf.native_transport_max_negotiable_version < Server.MIN_SUPPORTED_VERSION
                || conf.native_transport_max_negotiable_version > Server.CURRENT_VERSION)
            {
                throw new ConfigurationException(String.format("Invalid setting for native_transport_max_negotiable_version (%d); " +
                                                               ...
                                                               conf.native_transport_max_negotiable_version,
    ...
    {
        return conf.native_transport_max_negotiable_version;
    }
