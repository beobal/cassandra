 ...
 */
abstract class FrameDecoderWith8bHeader extends org.apache.cassandra.transport.FrameDecoder
{
     ...
     */
    abstract org.apache.cassandra.transport.FrameDecoder.Frame unpackFrame(ShareableBytes bytes, int begin, int end, long header);
     ...
     */
    @Inline
    protected void decode(Collection<org.apache.cassandra.transport.FrameDecoder.Frame> into, ShareableBytes newBytes, int headerLength)
    {
