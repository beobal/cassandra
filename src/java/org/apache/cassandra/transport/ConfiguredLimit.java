...
public abstract class ConfiguredLimit implements ProtocolVersionLimit
{
    ...
    public static ConfiguredLimit newLimit()
    {
        ...
        return fromConfig != Integer.MIN_VALUE
               ? new StaticLimit(ProtocolVersion.decode(fromConfig, () -> ProtocolVersion.MAX_SUPPORTED_VERSION))
    ...
    private static class DynamicLimit extends ConfiguredLimit
    {
        ...
        public void maybeUpdateVersion(boolean allowLowering)
        {
            ...
            if (enforceV3Cap)
            {
                if (ProtocolVersion.V3.isSmallerThan(getMaxVersion()) && !allowLowering)
                {
