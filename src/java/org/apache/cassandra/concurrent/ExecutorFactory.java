...
import static org.apache.cassandra.concurrent.InfiniteLoopExecutor.SimulatorSafe;
import static org.apache.cassandra.concurrent.InfiniteLoopExecutor.Daemon;
import static org.apache.cassandra.concurrent.InfiniteLoopExecutor.Daemon.NON_DAEMON;
import static org.apache.cassandra.concurrent.InfiniteLoopExecutor.Interrupts;
...
public interface ExecutorFactory extends ExecutorBuilderFactory.Jmxable<ExecutorPlus, SequentialExecutorPlus>
{
    ...
    public static final class Default extends NamedThreadFactory.MetaFactory implements ExecutorFactory
    {
        ...
        @Override
        public Interruptible infiniteLoop(String name, Interruptible.Task task, SimulatorSafe simulatorSafe, Daemon daemon, Interrupts synchronizeInterrupts)
        {
            return new InfiniteLoopExecutor(this, name, task, daemon, synchronizeInterrupts);
        }
