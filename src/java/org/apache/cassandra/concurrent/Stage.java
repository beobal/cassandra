...
public enum Stage
{
    ...
    private static ExecutorPlus tracingExecutor(String jmxName, String jmxType, int numThreads, LocalAwareExecutorPlus.MaximumPoolSizeListener onSetMaximumPoolSize)
    {
