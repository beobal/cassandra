...
{
    /** Cache capacity. The unit depends on whetherthe cache is weighted. If so, capacity is typically
     * specified in bytes (e.g. Row/Key/Counter caches). If unweighted, capacity is a max number of entries,
     * as is the case for Auth caches.
     */
    public final Gauge<Long> capacity;
    /** Total size of cache. As with capacity, the unit is dependent on whether the cache is weighted or not */
